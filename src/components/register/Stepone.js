                        ...
                        <div className='col-12 col-md-6'>
                            <div className="">
                                ...
                                <input
                                    ...
                                    onChange={(e) => setFormData({ ...formData, user: { ...formData.user, surname: e.target.value } })}
                        ...
                        <div className='col-12 col-md-6'>
                            <div className="">
                                ...
                                <input
                                    ...
                                    onChange={(e) => setFormData({ ...formData, user: { ...formData.user, phoneNumber: e.target.value } })}
                        ...
                        <div className='col-12 col-md-6'>
                            <div className="">
                                ...
                                <input
                                    ...
                                    onChange={(e) => setFormData({ ...formData, bio: { ...formData.bio, dob: e.target.value } })}
                    ...
                    <div className='d-flex justify-content-between flex-column flex-md-row align-items-sm-end align-items-md-center mt-5'>
                        <div>
                            <div className="">
                                ...
                                <div className='d-flex' onChange={(e) => setFormData({ ...formData, bio: { ...formData.bio, genderId: e.target.value } })}>
                                    <div className="form-check">
                                        <input type="radio" name='gender' className="form-check-input" value={1} id="male" />
                                        <label className="form-check-label" htmlFor="male">Male</label>
                                    </div>

                                    <div className="form-check ms-3">
                                        <input type="radio" name='gender' className="form-check-input" value={2} id="female" />
